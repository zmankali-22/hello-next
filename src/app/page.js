...
function Home() {
  ...
  return (
    <main>
      ...
      <p>
        Python is a high-level, interpreted programming language. In
        Python, you don't need to specify the data type of a variable
        when you declare it. Python automatically determines the data
      ...
      <p>
        Python has standard control flow structures like if
      ...
      <p>
        ...
        keyword. Python also has built-in data structures like lists
        and dictionaries.
      </p>
      <Revealed>
        <Code className="code-snippet" theme="dracula" lang="py">
